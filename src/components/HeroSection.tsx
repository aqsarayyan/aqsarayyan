    ...
    <section className="py-24 bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <Carousel>
          ...
          {/* NAV BUTTONS */}
          <CarouselPrevious className="bg-white/10 hover:bg-white/20 text-white border-white/10" />
          <CarouselNext className="bg-white/10 hover:bg-white/20 text-white border-white/10" />
